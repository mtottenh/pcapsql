...
impl Protocol for TlsProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("tls.record_type", DataType::UInt8, true),
            Field::new("tls.version", DataType::Utf8, true),
            Field::new("tls.handshake_type", DataType::UInt8, true),
            Field::new("tls.sni", DataType::Utf8, true),
            Field::new("tls.cipher_suites", DataType::Utf8, true),
            Field::new("tls.selected_cipher", DataType::Utf8, true),
        ]
    }
