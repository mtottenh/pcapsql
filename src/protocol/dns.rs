...
impl Protocol for DnsProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("dns.transaction_id", DataType::UInt16, true),
            Field::new("dns.is_query", DataType::Boolean, true),
            Field::new("dns.opcode", DataType::UInt8, true),
            Field::new("dns.is_authoritative", DataType::Boolean, true),
            Field::new("dns.is_truncated", DataType::Boolean, true),
            Field::new("dns.recursion_desired", DataType::Boolean, true),
            Field::new("dns.recursion_available", DataType::Boolean, true),
            Field::new("dns.response_code", DataType::UInt8, true),
            Field::new("dns.query_count", DataType::UInt16, true),
            Field::new("dns.answer_count", DataType::UInt16, true),
            Field::new("dns.authority_count", DataType::UInt16, true),
            Field::new("dns.additional_count", DataType::UInt16, true),
            Field::new("dns.query_name", DataType::Utf8, true),
            Field::new("dns.query_type", DataType::UInt16, true),
            Field::new("dns.query_class", DataType::UInt16, true),
        ]
    }
