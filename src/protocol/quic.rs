...
impl Protocol for QuicProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("quic.header_form", DataType::Utf8, true),
            Field::new("quic.long_packet_type", DataType::Utf8, true),
            Field::new("quic.version", DataType::UInt32, true),
            Field::new("quic.version_name", DataType::Utf8, true),
            Field::new("quic.dcid_length", DataType::UInt8, true),
            Field::new("quic.dcid", DataType::Utf8, true),
            Field::new("quic.scid_length", DataType::UInt8, true),
            Field::new("quic.scid", DataType::Utf8, true),
            Field::new("quic.token_length", DataType::UInt32, true),
            Field::new("quic.packet_length", DataType::UInt32, true),
            Field::new("quic.spin_bit", DataType::Boolean, true),
            Field::new("quic.key_phase", DataType::Boolean, true),
            Field::new("quic.sni", DataType::Utf8, true),
        ]
    }
