...
impl Protocol for IcmpProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("icmp.type", DataType::UInt8, true),
            Field::new("icmp.code", DataType::UInt8, true),
            Field::new("icmp.checksum", DataType::UInt16, true),
            Field::new("icmp.type_name", DataType::Utf8, true),
            Field::new("icmp.identifier", DataType::UInt16, true),
            Field::new("icmp.sequence", DataType::UInt16, true),
            Field::new("icmp.next_hop_mtu", DataType::UInt16, true),
            Field::new("icmp.gateway", DataType::Utf8, true),
        ]
    }
}
