...
impl Protocol for Ipv6Protocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            ...
            Field::new("ipv6.ext_hop_by_hop", DataType::Boolean, true),
            Field::new("ipv6.ext_routing", DataType::Boolean, true),
            Field::new("ipv6.ext_fragment", DataType::Boolean, true),
            Field::new("ipv6.ext_destination", DataType::Boolean, true),
            // Fragment header fields
            Field::new("ipv6.frag_offset", DataType::UInt16, true),
            Field::new("ipv6.frag_more", DataType::Boolean, true),
            Field::new("ipv6.frag_id", DataType::UInt32, true),
            // Routing header fields
            Field::new("ipv6.routing_type", DataType::UInt8, true),
            Field::new("ipv6.segments_left", DataType::UInt8, true),
        ]
    }
