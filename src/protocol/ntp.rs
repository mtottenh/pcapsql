...
impl Protocol for NtpProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("ntp.version", DataType::UInt8, true),
            Field::new("ntp.mode", DataType::UInt8, true),
            Field::new("ntp.leap_indicator", DataType::UInt8, true),
            Field::new("ntp.stratum", DataType::UInt8, true),
            Field::new("ntp.poll", DataType::UInt8, true),
            Field::new("ntp.precision", DataType::UInt8, true),
            Field::new("ntp.root_delay", DataType::UInt32, true),
            Field::new("ntp.root_dispersion", DataType::UInt32, true),
            Field::new("ntp.reference_id", DataType::Utf8, true),
            Field::new("ntp.reference_ts", DataType::Int64, true),
            Field::new("ntp.origin_ts", DataType::Int64, true),
            Field::new("ntp.receive_ts", DataType::Int64, true),
            Field::new("ntp.transmit_ts", DataType::Int64, true),
        ]
    }
