...
impl Protocol for ArpProtocol {
    ...
    fn schema_fields(&self) -> Vec<Field> {
        vec![
            Field::new("arp.hardware_type", DataType::UInt16, true),
            Field::new("arp.protocol_type", DataType::UInt16, true),
            Field::new("arp.hardware_size", DataType::UInt8, true),
            Field::new("arp.protocol_size", DataType::UInt8, true),
            Field::new("arp.operation", DataType::UInt16, true),
            Field::new("arp.operation_name", DataType::Utf8, true),
            Field::new("arp.sender_mac", DataType::FixedSizeBinary(6), true),
            Field::new("arp.sender_ip", DataType::Utf8, true),
            Field::new("arp.target_mac", DataType::FixedSizeBinary(6), true),
            Field::new("arp.target_ip", DataType::Utf8, true),
        ]
    }
}
