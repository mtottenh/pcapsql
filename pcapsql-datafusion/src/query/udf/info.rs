...
pub fn all_udfs() -> Vec<UdfInfo> {
    vec![
        ...
        UdfInfo {
            name: "is_private_ip",
            description: "Check if IPv4 is in RFC1918 private ranges",
            signature: "is_private_ip(uint32)",
            return_type: "Boolean",
            example: "is_private_ip(src_ip)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "is_multicast_ip",
            description: "Check if IPv4 is a multicast address (224.0.0.0/4)",
            signature: "is_multicast_ip(uint32)",
            return_type: "Boolean",
            example: "is_multicast_ip(dst_ip)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "is_loopback_ip",
            description: "Check if IPv4 is a loopback address (127.0.0.0/8)",
            signature: "is_loopback_ip(uint32)",
            return_type: "Boolean",
            example: "is_loopback_ip(src_ip)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "ip6",
        ...
        UdfInfo {
            name: "is_link_local_ip6",
            description: "Check if IPv6 is link-local (fe80::/10)",
            signature: "is_link_local_ip6(binary)",
            return_type: "Boolean",
            example: "is_link_local_ip6(src_ip)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "is_multicast_ip6",
            description: "Check if IPv6 is multicast (ff00::/8)",
            signature: "is_multicast_ip6(binary)",
            return_type: "Boolean",
            example: "is_multicast_ip6(dst_ip)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "mac",
        ...
        UdfInfo {
            name: "mac_is_broadcast",
            description: "Check if MAC is broadcast (ff:ff:ff:ff:ff:ff)",
            signature: "mac_is_broadcast(binary)",
            return_type: "Boolean",
            example: "mac_is_broadcast(dst_mac)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "mac_is_multicast",
            description: "Check if MAC is multicast (bit 0 of first octet = 1)",
            signature: "mac_is_multicast(binary)",
            return_type: "Boolean",
            example: "mac_is_multicast(dst_mac)",
            category: UdfCategory::Address,
        },
        UdfInfo {
            name: "mac_is_local",
            description: "Check if MAC is locally administered (bit 1 = 1)",
            signature: "mac_is_local(binary)",
            return_type: "Boolean",
            example: "mac_is_local(src_mac)",
            category: UdfCategory::Address,
        },
        // === Protocol Functions ===
        UdfInfo {
