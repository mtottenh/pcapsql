...
impl Protocol for HttpProtocol {
    ...
    fn schema_fields(&self) -> Vec<FieldDescriptor> {
        vec![
            ...
            FieldDescriptor::new("http.is_request", DataKind::Bool).set_nullable(true),
            // Request fields
            FieldDescriptor::new("http.method", DataKind::String).set_nullable(true),
            FieldDescriptor::new("http.uri", DataKind::String).set_nullable(true),
            FieldDescriptor::new("http.version", DataKind::String).set_nullable(true),
            // Response fields
            FieldDescriptor::new("http.status_code", DataKind::UInt16).set_nullable(true),
            FieldDescriptor::new("http.status_text", DataKind::String).set_nullable(true),
            // Common headers
            FieldDescriptor::new("http.host", DataKind::String).set_nullable(true),
            FieldDescriptor::new("http.content_type", DataKind::String).set_nullable(true),
            FieldDescriptor::new("http.content_length", DataKind::UInt64).set_nullable(true),
            FieldDescriptor::new("http.user_agent", DataKind::String).set_nullable(true),
            FieldDescriptor::new("http.server", DataKind::String).set_nullable(true),
        ]
    }
